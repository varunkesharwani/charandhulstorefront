...
const Page = () => {
  return (
    <div className="text-black font-sans bg-gray-50 min-h-screen">
  
      <section className="p-6 bg-white rounded-lg shadow-sm">
        <h2 className="text-2xl mb-3 font-semibold text-[#023047]">Privacy Policy</h2>
        ...
        <h3 className="text-xl mb-2 font-semibold">1. Information We Collect</h3>
        <p className="leading-7 mb-4">
        ...
        <h3 className="text-xl mb-2 font-semibold">2. How We Use Your Information</h3>
        <p className="leading-7 mb-4">
        ...
        <h3 className="text-xl mb-2 font-semibold">3. Sharing Your Information</h3>
        <p className="leading-7 mb-4">
        ...
        <h3 className="text-xl mb-2 font-semibold">4. Data Security</h3>
        <p className="leading-7 mb-4">
        ...
        <h3 className="text-xl mb-2 font-semibold">5. Cookies</h3>
        <p className="leading-7 mb-4">
        ...
        <h3 className="text-xl mb-2 font-semibold">6. Third-Party Links</h3>
        <p className="leading-7 mb-4">
          Occasionally, at our discretion, we may include or offer third-party products or services on our website. These third-party sites have separate and independent privacy policies. We therefore have no responsibility or liability for the content and activities of these linked sites. Nonetheless, we seek to protect the integrity of our site and welcome any feedback about these sites.
        </p>
        <h3 className="text-xl mb-2 font-semibold">7. Your Rights</h3>
        <p className="leading-7 mb-4">
        ...
        <h3 className="text-xl mb-2 font-semibold">8. Changes to This Privacy Policy</h3>
        <p className="leading-7 mb-4">
        ...
        <p className="leading-7 mb-4"><strong>Effective Date:</strong> 15/07/2024</p>
        <h3 className="text-xl mb-2 font-semibold">9. Contact Us</h3>
